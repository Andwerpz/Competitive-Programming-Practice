...
//UTPC Contest 1-29-25 Div.1 - E

//lil bit of geo. To make it easier, you can rotate the entire thing s.t. the sun is along the x axis. 
...
signed main() {
    ...
    while(q--){
        ...
        cin >> s >> m;
        s *= -1;
        ld s_ang = s.polar_angle();
        m = m.rotate_CCW(-s_ang);
        ld m_ang = m.polar_angle();
        if(m_ang < -pi / 2) cout << "Third quarter\n";
        else if(m_ang < 0) cout << "New moon\n";
        else if(m_ang < pi / 2) cout << "First quarter\n";
        else cout << "Full moon\n";
    }
