...
public class arraystabilizationgcdversionver2 {
	...
	public static void main(String[] args) throws IOException {
		...
		//solution too slow, either use cpp or try to find a better approach
		
		//we can binary search through the amounts of steps. to get the value of the ith number in the array at the jth step, we just need to gcd all numbers between i and i + j inclusive.
		//to get this number quickly, we can use a segment tree. 
