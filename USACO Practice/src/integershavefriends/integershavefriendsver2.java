...
public class integershavefriendsver2 {
	...
	public static void main(String[] args) throws IOException {
		...
		//for each position, we run a search for the longest subarray starting from that position. Too slow in java though. gonna have to find a way to make this thing faster
