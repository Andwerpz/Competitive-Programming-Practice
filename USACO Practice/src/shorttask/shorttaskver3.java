...
public class shorttaskver3 {
	public static void main(String[] args) throws IOException {
		...
		//use sieve of erathosenes type approach. For each multiple of 2, add 2, and so on. Then transfer the numbers over to an ans array, saving the lowest occurrence of each number.
