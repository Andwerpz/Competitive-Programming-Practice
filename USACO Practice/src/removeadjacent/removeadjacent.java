...
public class removeadjacent {
	public static void main(String[] args) throws IOException {
		...
		//the solution is to first check the highest; 'z' and work your way down to the lowest; 'a'. The reason behind this is that if you can't remove a letter, then you won't be able to 
		//remove it only by removing letters of lower value, since the letter of lower value requires a letter of even lower value to be removed.
