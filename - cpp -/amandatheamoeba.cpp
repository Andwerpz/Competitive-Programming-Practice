...
//annoying implementation problem. 

//it's useful to precompute for each tile, the minimum distance to a 'final tile' that the amoeba has to get to. 
