...
//UTPC Contest 02-09-24 Div. 2 - H

//if a topping is within the convex hull of all the crust points, then it's guaranteed
//that we can pick two crust points such that the triangle formed between the two points and the
//origin contains the topping point. 

//given n * log(n) preprocessing, we can check whether an arbitrary point lies inside a convex hull
//in log(n) time. 

//note that since it's guaranteed that there exists a crust point in each of the 4 quadrants, the origin
//is guaranteed to be inside the convex hull. 
