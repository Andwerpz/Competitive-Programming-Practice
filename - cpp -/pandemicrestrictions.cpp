...
//bruh, i initially thought that gradient descent could solve this, but josh pulls out a double ternary
//search solution and gets AC

//given a triangle, the point which minimizes the sum of distances from it to all 3 points of the triangle is
//the fermat point. I'll denote the sum of distances from the fermat point to the 3 points of the triangle as
//the fermat value. Then, the point where we want our house is the point which minimizes the fermat value for
//our house, and all 3 pairs of our friends. 

//This solution does a double ternary search over the x and y dimensions to determine the best location of
//our house. 
