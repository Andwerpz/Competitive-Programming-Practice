...
//i realize that i've been using a suffix automaton this whole time. 
...
struct SuffixTree {
    public:
        ...
        int count_occurrences(string s) {
            SuffixNode* node = find_node(s);
            return node == nullptr? 0 : leaf_cnt[find_node(s)->index];
        }
