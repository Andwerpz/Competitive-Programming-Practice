...
//identical to another problem on kattis: "greatfireball". 

//binary search for the radius. Given some radius, we can rotate the circle around the origin, and compute the maximum
//amount of bird spots in O(n * log(n)). 
