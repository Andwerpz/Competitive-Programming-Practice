...
class lightsonver2 {
    ...
    while(toProcess.size() != 0) {
    	...
    	for(int i = 0; i < conn.size(); i++) {
    		...
    		System.out.println("Visited Room to left? " + (temp[1] - 1 > -1 && visited[temp[0]][temp[1] - 1]));
    		System.out.println("Visited Room to right? " + (temp[1] + 1 < n && visited[temp[0]][temp[1] + 1]));
    		System.out.println("Visited Room to above? " + (temp[0] - 1 > -1 && visited[temp[0] - 1][temp[1]]));
    		System.out.println("Visited Room to below? " + (temp[0] + 1 < n && visited[temp[0] + 1][temp[1]]));
